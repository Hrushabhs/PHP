...
<body>
	...
	<!--	<img id="mainImage" src="images/bournelegacy.jpg" width="990" height="400" alt="image"/> -->
        ...
        <div id="menu">
            <ul>
                <li><a href="Index.php?PageName=Contact">Home</a></li>
        ...
        if(!empty($_GET['PageName'])){
            $Pages = ".";
            $PagesDir = scandir($Pages,0);
            unset($PagesDir[0],$PagesDir[1],$PagesDir[9],$PagesDir[10]); 
            $PageName = $_GET['PageName'];
            if(in_array($PageName.'.php',$PagesDir)){
                include($Pages.'/'.$PageName.'.php');
            }else{
                echo '<h2 id="request"> You are Lost </h2>';
                echo '<img src="images/Lost.gif" width="600px" height="430px">';
                echo '<h2> Sorry Your in wrong Place.';
    ...
    <section class="links">
	   ...
	   <br>
        ...
        <!-- Footer Area -->
        <div id="footer"><hr><p>Theme By | Hrushabh Sirsulwar |&copy;2016-2019 All right are Open Sourced :P.
	...
	<br>CSS Animations & Design for UI UX Designers. This is my web Pages that I used to learn PHP course. I like to share what I done I used this design template to just reduce time needs to create Entire pages from scratch. The PHP code that I used in the pages are create my me my following turorial <br>&trade; Hrushabh Sirsulwar &trade;DIEMS ; &trade; Skillshare ; &trade; StackSkills</p><hr>
