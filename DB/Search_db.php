...
if(isset($_GET['SearchButton'])){
	$Search=$_GET['Search'];
	$SearchQuery="SELECT * FROM emp_record WHERE name='$Search' OR emp_no='$Search' OR dept='$Search' OR salary='$Search'";
	...
	while($DataRows=mysql_fetch_array($Execute)){
		...
		<table width="1000" border="5" align="center">
			...
			<tr>
				...
				<td><?php echo $Addr;?></td>
				<td align="center"><a href="Search_db.php">Search Again</a></td>
